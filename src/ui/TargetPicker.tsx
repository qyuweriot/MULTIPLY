...
export function TargetPicker({ state, selection, moves, labels, onBack, onReset }: TargetPickerProps) {
  ...
  if (selection.step !== 'zone') steps.push(zoneName(selection.zone, labels))
